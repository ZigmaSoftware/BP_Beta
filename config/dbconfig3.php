...
if (!in_array($_SERVER['REMOTE_ADDR'], $whitelist)) {
    // ---------- PRODUCTION SERVER ----------
    $driver         = "mysql";
    $host           = "192.168.1.200";        // Zigfly Attendance DB server
    $username       = "my_root";              // DB user with attendance rights
    $password       = "my@123456";   // Replace with actual secure password
    $databasename   = "blueplanet";           // Attendance DB
} else {
    // ---------- DEVELOPMENT SERVER ----------
    $driver         = "mysql";
    $host           = "192.168.1.200";        // Same internal IP for test access
    $username       = "my_root";
    $password       = "my@123456";
    $databasename   = "blueplanet";
}
