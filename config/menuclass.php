...
class menu {
	protected $menu 	 		= null;
	protected $sub_menu  		= null;
	protected $menu_link 		= null;
...
class db
{
     ...
     */
     ...
     public function __construct($driver = 'mysql', $host = 'localhost', $user = 'zigma', $pass = '?WSzvxHv1LGZ', $name = 'blue_planet', $charset = 'utf8', $prefix = null)
    {
