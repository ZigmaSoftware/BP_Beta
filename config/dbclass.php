...
class db
{
    ...
    public function __construct($driver = 'mysql', $host = 'localhost', $user = 'zigma', $pass = '?WSzvxHv1LGZ', $name = 'blue_planet_beta', $charset = 'utf8', $prefix = null)
    {
	 ...
	 */
    public function select($table, $where = [], $limit = null, $start = null, $order_by = [],$function = "",$group_by = '',$having = '')
    {
