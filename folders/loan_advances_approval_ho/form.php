...
if(isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        $hod_approval       = $loan_values["hod_approval"];
        $hod_reason          = $loan_values["hod_reason"];
...
$approve_options    = select_option($approve_options,"Select",$hod_approval);
                        ...
                        <div class="col-12">
                           <div class="form-group row ">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-4">
                                    <select name="is_approved" id="is_approved" class="select2 form-control" onchange = "get_rejected_reason(this.value),get_ceo_name(this.value)" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 <?=$ceo_staff_class;?> ceo_staff_class">
                                    <select name="ceo_to_be_approved" id="ceo_to_be_approved" class="select2 form-control ceo_inp  ">
                                        <?php echo $ceo_staff_name_options;?>
                                    </select>
                                </div>
                                <label for="hod_reason" class="col-md-2 col-form-label  <?=$reject_class;?> reject_class"> Reason </label>
                                <div class="col-md-4">
                                    <textarea name="hod_reason" id="hod_reason" rows="4" class="form-control reason_inp  <?=$reject_class;?> reject_class"><?=$hod_reason;?></textarea>
                                </div>
                            </div>
                            <div class="form-group row ">
                                <div class="col-md-12">
