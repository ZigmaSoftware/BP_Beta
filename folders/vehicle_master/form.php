            ...
            <div class="card-body">
                ...
                <div class="row">                                    
                    <div class="col-12">
                            ...
                            <label class="col-md-2 col-form-label textright" for="vehicle_no">Vehicle No</label>
                                <div class="col-md-3">
                                    <input type="text" id="vehicle_no" name="vehicle_no" class="form-control" value="<?php echo $vehicle_no; ?>" required>
                                </div>  </div>
                                <div class="form-group row ">
