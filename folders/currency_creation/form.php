...
if(isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $country            = $result_values[0]["country"];
...
$country_options = select_option($country_options, "Select", $country)
                ...
                <div class="row">                                    
                    <div class="col-12">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-4">
                                    <select name="country" id="country" class="select2 form-control" required>
