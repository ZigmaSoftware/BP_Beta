...
switch ($action) {
    case 'createupdate':
        ...
        $screen_folder_name = $_POST["screen_folder_name"];
        ...
        $columns            = [
            ...
            "screen_section_unique_id"  => $section_name,
        ...
        $select_where       = '((main_screen_unique_id = "'.$main_screen.'"  AND screen_section_unique_id = "'.$section_name.'" AND screen_name = "'.$screen_name.'" OR (order_no ="'.$order_no.'" AND screen_section_unique_id = "'.$section_name.'") OR folder_name ="'.$screen_folder_name.'")) AND is_delete = 0 ';
    ...
    case 'datatable':
        ...
        $columns        = [
            "@a:=@a+1 s_no",
            "screen_name",
            "(SELECT section_name FROM user_screen_sections AS uss WHERE uss.unique_id = ".$table.".screen_section_unique_id ) AS section_screen",
        ...
        //     "is_delete"     => 0
        // ];
        // $order_by       = "screen_section_unique_id,main_screen_unique_id,order_no  ";
        ...
        if ($result->status) {
            ...
            foreach ($res_array as $key => $value) {
                ...
                $value['section_screen']  = disname($value['section_screen']);
