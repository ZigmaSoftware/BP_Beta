                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                 ...
                                 <div class="col-md-3">
                                <label class="col-md-12 col-form-label" for="item_status">Status</label>
                                <div class="col-md-12">
...
<!-- Modal -->
<div class="modal fade" id="approval_modal_form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header w-100 text-center">
                ...
                <select id="bulk_status_select" class="form-select form-select-sm" style="width:auto; display:inline-block;">
