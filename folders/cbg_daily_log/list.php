...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table id="cbg_daily_log_datatable" class="table dt-responsive nowrap w-100">
                    <thead class="table-light">
                        <tr>
                            <th>#</th>
                            <th>Date</th>
                            <th>Project</th>
                            <th>Waste Receive (Kg)</th>
                            <th>Waste Reject (Kg)</th>
                            <th>Waste Crushing (Kg)</th>
                            <th>Feeding (Kg)</th>
                            <th>Daily Gas Generation (%)</th>
                            <th>Total CBG Generation (Kg)</th>
                            <th>No. of Vehicles Filled</th>
                            <th>Remark</th>
                            <th>Action</th>
                        </tr>
                    </thead>
