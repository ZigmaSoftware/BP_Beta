...
var form_name = 'po_approval_level_3';
var table_id = 'po_approval_level_3_datatable';
var action = 'datatable';
var ajax_url = sessionStorage.getItem("folder_crud_link");
var url = sessionStorage.getItem("list_link");

function po_approval_level_3_cu(unique_id = "") {
    if (!is_online()) {
...
function po_approval_level_3_delete(unique_id = "") {
...
function po_approval_level_3_upload(unique_id){
