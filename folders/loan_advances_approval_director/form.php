...
if(isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        $director_approval  = $loan_values["director_approval"];
        $director_reason    = $loan_values["director_reason"];
...
$approve_options    = select_option($approve_options,"Select",$director_approval);
                    ...
                    <div class="row">                                    
                        <div class="col-12">
                           <div class="form-group row ">
                            ...
                            <div class="form-group row">
                                <label for="director_reason" class="col-md-2 col-form-label"> Reason </label>
                                <div class="col-md-4">
                                    <textarea name="director_reason" id="director_reason" rows="4" class="form-control " required><?=$director_reason;?></textarea>
                                </div>
                            </div>
                            <div class="form-group row ">
                                <div class="col-md-12">
