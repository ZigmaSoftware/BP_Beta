    ...
    case 'datatable':
        ...
        if ($result->status) {
            ...
            foreach ($res_array as $key => $value) {
                ...
                if ($value['certificate_type'] == 1) {
                    $value['certificate_type'] = "Live";
                } else {
                    $value['certificate_type'] = "Relieve(d)";
                }
                
                $btn_view             = btn_print1($folder_name,$value['unique_id'],'service_certificate',"","","");
