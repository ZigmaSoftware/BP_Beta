$(document).ready(function () {
	// var table_id 	= "service_certificate_datatable";
	
	relieve_date_show();
	init_datatable(table_id,form_name,action);
	
	var purpose_type = document.getElementById('purpose_type').value;
	...
	if(purpose_type !=''){
		...
		document.getElementById('hidden_add1').style.display = "none";
	}
...
function service_certificate_cu(unique_id = "") {
...
function service_certificate_delete(unique_id = "") {
...
function showDiv(){
	...
	// let purpose_type = $("#purpose_type").val().focus();
	...
	else if(purpose_type==others){
		document.getElementById('hidden_div').style.display = "none";
		document.getElementById('hidden_div1').style.display = "none";
		// document.getElementById('purpose').value='';
		document.getElementById('address').value='';
		document.getElementById('hidden_add').style.display = "block";
		document.getElementById('hidden_add1').style.display = "block";
	}
	else{
		document.getElementById('hidden_div').style.display = "block";
		document.getElementById('hidden_div1').style.display = "block";
