...
switch ($action) {
    case 'createupdate':
        $branch_name         = $_POST["branch_staff_name"];
        $exp_no              = $_POST['exp_no'];
        $entry_date          = $_POST["entry_date"];
        $description         = $_POST['description'];
        $unique_id           = $_POST["unique_id"];
        $branch_staff_name   = $_POST["branch_staff_name_type"];
        $designation         = $_POST["designation_unique_id"];
        ...
        $columns            = [
            "branch_unique_id"      => $branch_name,
            "entry_date"            => $entry_date,
            "description"           => $description,
            "staff_branch_type"     => $branch_staff_name,
        ...
        $select_where       = 'branch_unique_id = "' . $branch_name . '" AND entry_date="' . $entry_date . '" AND is_delete = 0  ';
