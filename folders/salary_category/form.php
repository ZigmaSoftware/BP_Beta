                ...
                <div class="row">                                    
                    <div class="col-12">
                            ...
                            <div class="form-group row ">
                                <label class="col-md-2 col-form-label textright" for="salary_category"> Salary Category </label>
                                <div class="col-md-3">
                                    <input type="text" id="salary_category" name="salary_category" class="form-control" value="<?php echo $salary_category; ?>" required>
                                </div> </div>
                                <div class="form-group row ">
