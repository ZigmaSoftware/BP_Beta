...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $likeMost                   = $result_values[0]["likeMost"];
            $improvement                 = $result_values[0]["improvement"];
            $comeBack                   = $result_values[0]["comeBack"];
            $comments                   = $result_values[0]["comments"];
            $remarks                   = $result_values[0]["remarks"];
            $employment_reason          = $result_values[0]["employment_reason"];
            $dissatisfaction_reason     = $result_values[0]["dissatisfaction_reason"];
            $otherReasonText            = $result_values[0]["otherReasonText"];
                ...
                <form class="was-validated" autocomplete="off">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="hidden" id="staff_name" name="staff_name" value='<?php echo  $staff_name; ?>'>
                            <input type="hidden" id="designation_name" name="designation_name" value='<?php echo  $designation_name; ?>'>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12"> <label for="reason">1. What is your principal reason for leaving the organization?</label> </div>
                                <div class="col-md-6"> <select name="reason" id="reason" class="select2 form-control" onchange="getSelectedValue(this);"><?php echo $reason_options; ?></select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" id="otherReasonTextArea" style="display: none;">
                                <div class="col-md-12"> <label for="otherReasonText">Please specify the other reason:</label></div>
                                <div class="col-md-6"> <textarea id="otherReasonText" name="otherReasonText" class="form-control"><?php echo $otherReasonText; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12"><label for="likeMost">2. What did you like the most about your employment experience at Xeon?</label> </div>
                                <div class="col-md-6"> <textarea id="likeMost" name="likeMost" class="form-control"><?php echo $likeMost; ?></textarea></div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12"><label for="improvement">3. What are the areas of improvement you would like to suggest?</label></div>
                                <div class="col-md-6"><textarea id="improvement" name="improvement" class="form-control"><?php echo $improvement; ?></textarea></div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12"> <label for="comeBack">4. Would you be interested in coming back to Xeon for suitable employment in the future? Yes / No:</label> </div>
                                <div class="col-md-6"> <select name="comeBack" id="comeBack" class="select2 form-control"><?php echo $comeBack_options; ?></select></div>

                            </div>
                            <div class="form-group row">
                                <div class="col-md-12"><label for="comments">5. Please give your comments:</label></div>
                                <div class="col-md-6"> <textarea id="comments" name="comments" class="form-control"><?php echo $comments; ?></textarea></div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12"><label for="remarks">6. Please feel free to give any other remarks:</label></div>
                                <div class="col-md-6"> <textarea id="remarks" name="remarks" class="form-control"><?php echo $remarks; ?></textarea></div>
                            </div>
                        </div>
