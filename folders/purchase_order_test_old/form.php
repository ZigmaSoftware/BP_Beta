        ...
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              ...
              <table id="purchase_order_sub_datatable" class="table dt-responsive nowrap w-100">
                <thead>
                  ...
                  <tr id="po_details_form">
                    <input type="text" name="sublist_unique_id" id="sublist_unique_id" value="">
                    <th>#</th>
                    <th>
          ...
          <th>
            <input type="text" id="uom" name="uom" class="form-control" readonly placeholder="UOM">
                    ...
                    <th>
                      <input type="number" id="discount" name="discount" class="form-control" placeholder="%" onkeyup='sub_total_amount();' step="1" required>
                    </th>
                    <th>
...
<!--<div class="row" id="pr_sublist_section" style="display: none;">-->
<!--  <div class="col-md-12">-->
<!--    <div class="card">-->
<!--      <div class="card-body">-->
<!--        <h5>Purchase Requisition Sublist</h5>-->
<!--        <div id="pr_sublist_content"></div>-->
<!--      </div>-->
<!--    </div>-->
<!--  </div>-->
<!--</div>-->

<!--<div class="modal fade" id="prSublistModal" tabindex="-1" role="dialog" aria-labelledby="prSublistModalLabel" aria-hidden="true">-->
