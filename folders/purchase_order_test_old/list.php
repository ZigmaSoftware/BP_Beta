    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">                                    
                    <div class="col-12">
                       ...
                       <div class="form-group row">
                        ...
                        <label class="col-md-1 col-form-label" for="from_date"> From Date </label>
                        <div class="col-md-2">
                        ...
                        <label class="col-md-1 col-form-label" for="to_date"> To Date </label>
                        <div class="col-md-2">
                ...
                <table id="purchase_order_datatable" class="table dt-responsive nowrap w-100">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>PO Number</th>
