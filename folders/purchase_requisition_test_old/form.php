...
<div class="form-group row">
    <label class="col-md-2 col-form-label">PR Number</label>
    <div class="col-md-4">
...
<div class="col-12">
    <!-- Table Begins -->
    <table id="purchase_sublist_datatable" class="table dt-responsive nowrap w-100">
        <thead>
            <tr>
                <th>#</th>
                <th>Item Code</th>
            ...
            <tr id="requisition_details_form">
                ...
                <th>
                    <input type="date" id="required_delivery_date" name="required_delivery_date" class="form-control">
                </th>
                <th>
