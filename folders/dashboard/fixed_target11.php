        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php if(($is_team_head == 0)&&($_SESSION['sess_user_type'] != '5f97fc3257f2525529')) { ?>
                    <div class="row ">
                        <div class="col-md-12">
                                <h5 class="text-dark d-inline" onclick="test_function();">
                                    Target (100 %):
                                    <span class="text-primary font-weight-bold" id="staff_target">0.00 </span> 
                                </h5>
                                
                                <h5 class="text-dark d-inline float-right" id="team_head_achived" onclick="">
                                    Achieved (
                                        <span id="staff_archieved_percentage">0</span>%): <span class="text-primary font-weight-bold" id="staff_archieved">0.00 </span>
                                </h5>
                        ...
                        <div class="col-md-12">
                            ...
                            <!-- AM Chart Begins -->
                            <div id="fixed_target_am_chart"></div>
                            <!-- AM Chart Ends -->
                        </div>
                    </div>
                <?php } else { ?>
