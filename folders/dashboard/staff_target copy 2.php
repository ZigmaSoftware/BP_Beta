...
?>
         <tr class="collapse nest_col_<?=$team_head_staff_id; ?>">
            ...
            <td>
               <div class="progress mb-0">
                  <div class="progress-bar progress-bar-striped bg-info" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 75%"></div>
               </div>
               75%
            </td>
...
<?php
    ...
    else
    {
        ...
        $tar_arr = ["target" => moneyFormatIndia($member_target_amount) , "staff_id" => $team_member_staff_id, "staff_name" => $team_member_staff_name, "archieved" => moneyFormatIndia($commit_amount) , "percentage" => $percentage];
