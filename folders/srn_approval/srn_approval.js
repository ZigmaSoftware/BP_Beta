...
function srn_approval_cu(unique_id = "") {
    ...
    let approve_status = $("#srn_approval").val();
...
function srn_approval_upload(unique_id){
...
function toggleRemark() {
    const approval = document.getElementById("srn_approval").value;
