                                        ...
                                        if (!empty($_GET["unique_id"])) {
                                            ...
                                            if ($result->status) {
                                                ...
                                                foreach ($res_array as $key => $value) {
                                                    ...
                                                    $table_data .="<td class='' style='color:#1abc9c;font-weight:bold;font-size:14px;' onclick=new_external_window('folders/salary_ceo_approval/staff_wise_salary_details.php?department=".$department."&unique_id=".$unique_id."');>".($value['salary_type'])."</td>";
                    ...
                    <div class="row">                                    
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-5">
                                    <select name="app_status" id="app_status"  class="select2 form-control" required>
                                        ...
                                        <option value='3' <?php if($data_val_main[0]['ceo_approval']=='3'){ echo "selected"; } ?>>Approved</option>
                                        <option value='2' <?php if($data_val_main[0]['ceo_approval']=='2'){ echo "selected"; } ?>>Cancel</option>
                                    </select>
                                </div>
                            </div>
                        </div>                              
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <textarea name="description" id="description" class=" form-control" rows="5"><?php echo $data_val_main[0]['ceo_reason']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
