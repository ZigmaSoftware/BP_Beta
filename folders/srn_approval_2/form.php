...
if($checked_by){
    $checked_by = user_name($checked_by)[0]['user_name'];
}
...
<div class="row">
    <div class="col-12">
        ...
        <label class="col-md-1 col-form-label" for="srn_number" <?= $is_update_mode ? '' : 'style="display:none;"' ?>>SRN Number</label>
        <div class="col-md-2" <?= $is_update_mode ? '' : 'style="display:none;"' ?>>
            <input type="text" name="srn_number" id="srn_number" class="form-control"
                value = "<?= $srn_number ?>" readonly>
        </div>
        <label class="col-md-1 col-form-label" for="srn_date" <?= $is_update_mode ? '' : 'style="display:none;"' ?>>SRN Date</label>
        <div class="col-md-2" <?= $is_update_mode ? '' : 'style="display:none;"' ?>>
            <input type="date" name="srn_date" id="srn_date" class="form-control"
                value = "<?= $entry_date ?>" readonly>
        </div>
        <label class="col-md-1 col-form-label" for="po_date">PO Date</label>
        <div class="col-md-2">
        ...
        <div class="col-md-3 col-sm-12 col-12">
            ...
            <div class="form-group row">
                <label class="col-md-4 col-form-label" for="o_invoice">Original Invoice</label>
                <div class="col-md-8">
            ...
            <!--</div>-->
            <div class="form-group row">
                <label class="col-md-4 col-form-label" for="om_manual">O&M Manual</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label class="col-md-4 col-form-label" for="deli_challan_no">Delivery Challan No</label>
                <div class="col-md-8">
        ...
        <div class="col-md-3 col-sm-12 col-12">
            ...
            <div class="form-group row">
                <label class="col-md-4 col-form-label" for="deli_challan">Delivery Challan</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label class="col-md-4 col-form-label" for="amd_no">AMD No</label>
                <div class="col-md-8">
                    <input type="text" id="amd_no" name="amd_no" class="form-control" onkeypress='number_only(event);' value="<?= $amd_no; ?>" readonly>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-4 col-form-label" for="tax_invoice_no">Tax Invoice No</label>
                <div class="col-md-8">
        ...
        <div class="col-md-3 col-sm-12 col-12">
            ...
            <div class="form-group row">
                ...
                <label class="col-md-4 col-form-label" for="transporter_name">Transporter</label>
                <div class="col-md-8">
                    <input type="text" id="transporter_name" name="transporter_name" class="form-control" value="<?= $transporter_name; ?>" readonly>
                </div>

                <label class="col-md-4 col-form-label" for="test_cert">Test Certificate</label>
                <div class="col-md-8">
                ...
                <label class="col-md-4 col-form-label" for="cost_center">Cost Center</label>
                <div class="col-md-8">
                    <input type="text" id="cost_center" name="cost_center" class="form-control" value="<?= $cost_center; ?>" readonly>
                </div>
                <label class="col-md-4 col-form-label" for="tax_invoice_date">Tax Invoice Date</label>
                <div class="col-md-8">
        ...
        <div class="col-md-3 col-sm-12 col-12">
            <div class="form-group row">
                ...
                <label class="col-md-4 col-form-label" for="received">Received At</label>
                <div class="col-md-8">
                    <input type="text" id="received" name="received" class="form-control" value="<?= $received ?>" readonly>
                </div>
                <label class="col-md-4 col-form-label" for="vehicle_no">Vehicle No</label>
                <div class="col-md-8">
                    <input type="text" id="vehicle_no" name="vehicle_no" class="form-control" value="<?= $vehicle_no; ?>" readonly>
                        ...
                        <div class="row">
                            <div class="col-12">
                            <!-- Table Begiins -->
                                <table id="srn_sublist_datatable" class="table dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Product Name</th>
                       ...
                       <div class="form-group row">
                            <label for="checked_by" class="col-md-2 col-form-label">Checked By</label>
                            <div class="col-md-4">
                                <input type="text" name="checked_by" id="checked_by" class="form-control" value="<?= $checked_by ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row" id="check_remark_div">
                            <label for="check_remarks" class="col-md-2 col-form-label">Check Remark</label>
                            <div class="col-md-6">
                                <textarea name="check_remarks" id="check_remarks" class="form-control" rows="3" placeholder="Enter your remark" readonly><?= $check_remarks ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select name="srn_approval_2" id="srn_approval_2" class="form-control" onchange="toggleRemark()">
                        ...
                        <div class="form-group row" id="status_remark_div" style="display: none;">
                            ...
                            <div class="col-md-6">
                                <textarea name="status_remark" id="status_remark" class="form-control" rows="3" placeholder="Enter your remark"><?= $status_remark ?></textarea>
                            </div>
                        </div>
