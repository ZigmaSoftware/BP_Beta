...
function sales_order_approval_cu(unique_id = "") {
    ...
    let approve_remarks = $("#approval_remarks").val();
    
    alert(approve_status);

    let data = new FormData();
    data.append("approve_status", approve_status);
    data.append("approve_remarks", approve_remarks);
...
var approve_status  = $("#status_filter").val();
...
// Delete Function
function sales_order_approval_delete(unique_id = "") {
    Swal.fire({
        title: 'Are you sure?',
        html: `
...
function sales_order_approval_upload(unique_id){
