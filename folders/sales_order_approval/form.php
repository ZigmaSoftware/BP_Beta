            ...
            <div class="card-body">
                <form class="was-validated" id="purchase_requisition_form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <select name="currency" id="currency" class="select2 form-control" required <?= $disable; ?>>
                                <?= $currency_options; ?>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            <input type="text" id="exchange_rate" name="exchange_rate" class="form-control" value="<?php echo $exchange_rate; ?>" required <?= $disable; ?>>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input type="text" id="contact_person_name" name="contact_person_name" class="form-control" value="<?php echo $contact_person_name; ?>" required <?= $disable; ?>>
                        </div>

                        <label class="col-md-2 col-form-label textright" for="customer_po_no"> Customer PO Number</label>
                        <div class="col-md-3">
                            <input type="text" id="customer_po_no" name="customer_po_no" class="form-control" value="<?php echo $customer_po_no; ?>" required <?= $disable; ?>>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" name="customer_po_date" id="customer_po_date" class="form-control" value="<?php echo !empty($customer_po_date) ? $customer_po_date : $today_date; ?>" required <?= $disable; ?>>
                        </div>

                        <label class="col-md-2 col-form-label textright" for="status"> Active Status</label>
                        <div class="col-md-3">
                            <select name="status" id="status" class="select2 form-control" required <?= $disable; ?>>
                    ...
                    <div class="col-12">
                        <!-- Table Begins -->
                        <table id="so_sublist_datatable" class="table table-striped dt-responsive nowrap w-100">
...
<!-- </thead> -->
                                ...
                                <!--    </th>-->
                                <!--    <th>-->
                                <!--        <input type="text" id="amount" name="amount" class="form-control" value="" onkeypress='number_only(event);' >-->
                                <!--    </th>-->
                                <!--    <th>-->
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label textright" for="approval_status">Approval Status</label>
                        <div class="col-md-3">
                            <select name="approval_status" id="approval_status" class="form-control select2">
                                <option value="">Select</option>
                                <option value="1" <?= ($approve_status == "1") ? "selected" : "" ?>>Approved</option>
                                <option value="2" <?= ($approve_status == "2") ? "selected" : "" ?>>Rejected</option>
                            </select>
                        </div>
                    
                        <label class="col-md-2 col-form-label textright" for="approval_remarks">Remarks</label>
                        <div class="col-md-3">
                            <textarea id="approval_remarks" name="approval_remarks" class="form-control" rows="2"><?= $approve_remarks ?? "" ?></textarea>
                        </div>
                    </div>
