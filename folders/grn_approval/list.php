...
<div class="col-md-2">
                        <label class="col-md-12 col-form-label" for="grn_status">Status</label>
                        <div class="col-md-12">
                            <select name="grn_status" id="grn_status" class="form-control">
...
<div class="col-md-2">
                        <div class="col-md-12 mt-4">
                            <button type="button" class="btn btn-primary btn-rounded" onclick="grnApprovalFilter();">Go</button>
                        </div>
                    </div>
                    </div>
                </form>
                ...
                <div class="table-responsive">
                    <table id="grn_datatable" class="table table-striped table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            <!-- Populated dynamically via DataTable -->
                        </tbody>                                            
                </table>
                </div>
            </div> <!-- end card-body -->
