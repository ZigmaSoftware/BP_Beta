                ...
                <div class="row">
                    ...
                    <div class="col-12">                            
                       <div class="row">
                        ...
                        <div class="row">
                            <label class="col-md-2 col-form-label" for="ceo_approval">CEO Approval </label>
                            <div class="custom-control custom-radio">
                              <input type="radio" id="yes" name="yes" class="custom-control-input" value="1" required>
                              <label class="custom-control-label text-primary" for="yes">Yes</label>
                           </div>&nbsp;&nbsp;
                           <div class="custom-control custom-radio">
                              <input type="radio" id="no" name="no" class="custom-control-input" value="0" required>
                              <label class="custom-control-label text-danger" for="no">No</label>
                           </div>
                        </div>
                        <div class="row form-group">
                            <label class="col-md-2 col-form-label" for="ho_instruction"> HO Instruction </label>
                            <div class="col-md-6">
                                <textarea id="ho_instruction" name="ho_instruction" rows="5" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="row form-group">
