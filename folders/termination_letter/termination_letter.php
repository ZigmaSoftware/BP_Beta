...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $date_of_termination        = $result_values["date_of_termination"];
...
$letter_day         = date('d', strtotime($date_of_termination));
$letter_position    = date('S', strtotime($date_of_termination));
$letter_month_year  = date('F Y', strtotime($date_of_termination));
    ...
    <div class="col-12">
        <div class="card-bg">
            <div class="">
                ...
                <?php } ?>-->
                <?php  if (($company_name == "")||($company_name == 'Xeon')) { ?>
                    <div class="page-header" style="margin-bottom: 20px;">
                         <img src="assets/images/blue_planet_logo.png" id="header_img" class="m-6 p-0 "  width="10%" alt="Header Image">
                    </div>
                <?php } ?> 
                ...
                <div class="row mt-3" style="margin-bottom: 17px;">
                    <div class="col-md-5">
                        ...
                        <h5 class="head-bold text-secondry mb-1">Ref : <?= $result_values['termination_letter_no']; ?></h5>
                    </div>
                </div>
                <!-- end row -->
                <div class="row">
                    <div class="col-12">
                        <div class="mt-3">
                            ...
                            <h5 class="text-secondry mb-1"><b>Location <span class="colon-span-branch"> :</span></b><?= $result_values['work_location']; ?></h5></br>

                            <h5 class="head-bold text-secondry mb-1">Dear <?= $mr_ms; ?> <?= $staff_name; ?>,</h5>
                            <p class="bold-text mt-3" style="margin-bottom: 46px; text-align: center"><u class="p-indent" style="color: #000;">TERMINATION LETTER</u></p>
                            <p class="p-indent">We regret to inform you that your employment is officially terminated from BLUE PLANET ENVIRONMENTAL SOLUTIONS INDIA PRIVATE 
LIMITED on <?= $letter_day ?><sup><?= $letter_position; ?></sup> <?= $letter_month_year; ?>.</p></br>
                            <p class="p-indent">The reason for termination of employment is code of conduct & irresponsible behaviour.</p></br>
                            <p class="p-indent">The decision is final and irrevocable.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12  mt-2 mb-2" style="margin-bottom: 10px !important;">
                        <h4 class="text-secondry bold-text"><span style="font-weight : initial;">For</span> BLUE PLANET ENVIRONMENTAL SOLUTIONS INDIA PRIVATE 
LIMITED</h4>
                    </div>
                     <br>
