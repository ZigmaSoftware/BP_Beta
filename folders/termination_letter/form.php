...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $work_location                     = $result_values["work_location"];
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row ">
                                ...
                                <label class="col-md-2 col-form-label" for="work_location"> Location </label>
                                <div class="col-md-4">
                                    <input type="text" id="work_location" name="work_location" class="form-control" value="<?php echo $result_values['location']; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row ">
                                <label class="col-md-2 col-form-label" for="date_of_termination"> Date Of Termination </label>
                                <div class="col-md-4">
                                    <input type="date" id="date_of_termination" name="date_of_termination" class="select2 form-control" value="<?php echo $result_values['date_of_termination']; ?>" required>
                                </div>
                                </div>
                            <div class="form-group row ">
                                <div class="col-md-12">
