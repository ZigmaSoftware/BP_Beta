...
$(document).ready(function () {
    const table_id = 'payment_type_datatable';
    const form_name = 'Payment Type';
...
var form_name 		= 'Payment Type';
var form_header		= '';
var form_footer 	= '';
var table_name 		= '';
var table_id 		= 'payment_type_datatable';
var action 			= "datatable";

function payment_type_cu(unique_id = "") {
...
document.getElementById('payment_name').addEventListener('input', function () {
