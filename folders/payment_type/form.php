...
if(isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $payment_name         = $result_values[0]["payment_name"];
                ...
                <div class="row">                                    
                    <div class="col-12">
                            ...
                            <div class="form-group row ">
                                <label class="col-md-2 col-form-label textright" for="payment_name">Payment Type Name</label>
                                <div class="col-md-3">
                                    <input type="text" id="payment_name" name="payment_name" class="form-control" value="<?php echo $payment_name; ?>" required>
                                </div></div>
