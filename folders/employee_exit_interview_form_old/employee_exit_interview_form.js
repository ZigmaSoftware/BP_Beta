...
var form_name 		= 'Employee Exit Interview Datatable';
var form_header		= '';
var form_footer 	= '';
var table_name 		= '';
var table_id 		= 'employee_exit_interview_form_datatable';
...
//         // }
// }
function employee_exit_interview_form_cu(unique_id = "") {
...
function employee_exit_interview_form_delete(unique_id = "") {
...
function get_esi_pf(esi_pf_opt){
	
	
	var opt = $("#pf_esi").val();
	
	if(opt == '1'){
		document.getElementById('esi_opt').style.display = "block";
    }
}
