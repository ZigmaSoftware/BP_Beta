...
switch ($action) {
    case 'createupdate':
        ...
        $columns            = [
            ...
            "approve_by"         => $_SESSION['staff_id'],
            "approve_time"       => date('H:i:s'),
            "hod_reject_reason"  => $_POST['rejected_reason'],
    ...
    case 'datatable':
        ...
        if ($_SESSION['sess_user_type'] != $admin_user_type) {
            $where = "c.is_delete = '0' AND  b.reporting_officer = '".$_SESSION['staff_id']."' and ceo_name != 'staff5ffa90e8f01ed39207'";
        }else{
            $where = " c.is_delete = '0' and ceo_name != 'staff5ffa90e8f01ed39207'";
        }
       ...
       // if (isset($_POST['to_date'])) {
        ...
        if ($result->status) {
            ...
            foreach ($res_array as $key => $value) {
                ...
                if (($value['is_approved'] != "0")||($_POST['from_date'] > $today)||($value['hr_approved'] == "1")) {
