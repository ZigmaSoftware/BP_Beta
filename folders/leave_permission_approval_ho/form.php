...
if(isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
           ...
           // $rejected_reason    = $result_values["rejected_reason"];
                    ...
                    <div class="row">                                    
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <textarea name="rejected_reason" id="rejected_reason" rows="4" class="form-control reason_inp  <?=$reject_class;?> reject_class"><?=$rejected_reason;?></textarea>
                                </div>
                            </div><br><br>
                            <div class="form-group row ">
