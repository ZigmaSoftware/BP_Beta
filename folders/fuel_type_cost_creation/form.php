                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="form-group row ">
                                <label class="col-md-2 col-form-label textright " for="travel_type">Travel Type</label>
                                <div class="col-md-3">
                            ...
                            <div class="form-group row ">
                                <label class="col-md-2 col-form-label textright" for="vehicle_type"> Vehicle Type</label>
                                <div class="col-md-3">
                                ...
                                <div class="form-group row ">
                                <label class="col-md-2 col-form-label textright" for="fuel_type">Fuel Type</label>
                                <div class="col-md-3">
                            ...
                            <div class="form-group row ">
                                <label class="col-md-2 col-form-label textright" for="rate">Rate</label>
                                <div class="col-md-3">
