...
$(document).ready(function() {
    ...
    var table = $('#complete_srn_datatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": ajax_url,
            ...
            "data": function(d) {
                ...
                // d.pr_number = $('#pr_number').val();
                d.srn_date_from = $('#srn_date_from').val(); 
                d.srn_date_to = $('#srn_date_to').val();     
                d.status        = $('#pr_status').val();  
            }
        },
        "columns": [
            { "data": "s_no" },
