...
switch ($action) {
    case 'createupdate':
        ...
        $columns            = [
            ...
            "file_name"         => $_POST['dash_file_name'],
            "is_active"         => $_POST['is_active'],
    ...
    case 'datatable':
        ...
        if ($result->status) {
            ...
            foreach ($res_array as $key => $value) {
                $value['menu_name'] = disname($value['menu_name']);

            // Generate toggle + update buttons
            ...
            // Replace is_active value with styled string
            $value['is_active'] = ($value['is_active'] == "1")
                ? "<span style='color:green'>Active</span>"
                : "<span style='color:red'>Inactive</span>";
            
            // ✅ No need to unset anything now
