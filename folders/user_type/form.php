                ...
                <div class="row">                                    
                    <div class="col-12">
                            ...
                            <label class="col-md-2 col-form-label textright" for="user_type"> User Type </label>
                                <div class="col-md-3">
                                    <input type="text" id="user_type" name="user_type" onKeyup="get_under_user_type(this.value)" class="form-control" value="<?php echo $user_type; ?>" required>
                                </div>
                                 </div>
                                 <div class="form-group row ">
                            ...
                            <div class="form-group row "> 
                                <label class="col-md-2 col-form-label textright" for="under_user_type"> Under Users </label>
                                <div class="col-md-3">
