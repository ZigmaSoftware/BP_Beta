            ...
            <div class="card-body">
                <form class="was-validated first_form" name = "first_form">
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="supplier_name"> Supplier Name </label>
                        <div class="col-md-4">
                           <select name="supplier_name" id="supplier_name" class="select2 form-control" required >
                           <?=$supplier_name_options;?>                                   
                           </select>
                        </div>
                        <label class="col-md-2 col-form-label" for="purchase_order_no"> Purchase Order No  </label>
                        <div class="col-md-4">
                      ...
                      <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="branch"> Branch </label>
                        <div class="col-md-4">
                           <select name="branch" id="branch" class="select2 form-control" required >
                           <?=$branch_name_options;?>                                   
                           </select>
                        </div>
                        <label class="col-md-2 col-form-label" for="purchase_order_no"> Entry Date </label>
                        <div class="col-md-4">
                     ...
                     <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="purchase_type"> Purchase Type </label>
                        <div class="col-md-4">
                           <select name="purchase_type" id="purchase_type" class="select2 form-control" required >
                           <?=$purchase_type_options;?>                                   
                           </select>
                        </div>
                        <label class="col-md-2 col-form-label" for="purchase_order_no"> Purchase Request No </label>
                        <div class="col-md-4">
                            ...
                            <!-- Table Begiins -->
                                <table id="purchase_order_sub_datatable" class="table dt-responsive nowrap w-100">
                                    ...
                                    <tfoot>
                                        ...
                                        <th></th>
                                        <th></th>
                                        <th><input type="text" id="total_quantity" name="total_quantity" class="form-control" readonly value="" required></th>
                                        <th></th>
                                        <th></th>
                                        <th></th>
                                        <th><input type="text" id="total_sub_amount" name="total_sub_amount" class="form-control" readonly value="" required></th>
                                        <th></th>
                                    </tfoot>
