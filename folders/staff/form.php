...
//5ff71f5fb5ca556748
  ...
  if(isset($_GET["unique_id"])) {
      if (!empty($_GET["unique_id"])) {
          ...
          $table_asset = "staff_asset_details";
          $columns    = [
              "staff_name",
              "employee_id",
              "date_of_join",
...
$work_location_options    = work_location();
$work_location_options    = select_option($work_location_options,"Select The Work Location",$work_location);
                ...
                <div class="tab-content b-0 mb-0 pt-0">
                    ...
                    <div class="tab-pane active" id="officialdetails_tab">
                     <!-- Form Begins Here -->
                        <form class="was-validated staff_profile_form" id="staff_profile_form">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <label class="col-md-2 col-form-label" for="father_name"> Father Name <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <input  pattern="[a-zA-Z\- \/_?:.,\s]+" type="text" id="father_name" name="father_name" class="form-control" value="<?php echo $father_name; ?>" <?=$req;?> required>
                                        </div>
                                       </div>
                                       <div class="form-group row ">
                                          <label class="col-md-2 col-form-label" for="date_of_birth"> Date Of Birth <span style="color:red">*</span> </label>
                                          <div class="col-md-4">
                                          ...
                                          <label class="col-md-2 col-form-label" for="doc_dob"> Document DOB <span style="color:red">*</span> </label>
                                          <div class="col-md-4">
                                             <input type="date" name="doc_dob" class="form-control" value="<?php echo $doc_dob; ?>"<?=$req;?> required >
                                          </div>
                                       </div>
                                       <div class="form-group row ">
                                          <label class="col-md-2 col-form-label" for="age"> Age <span style="color:red">*</span> </label>
                                          <div class="col-md-4">
                                             <input type="text" onkeypress="return isNumber(event)" maxlength="3" id="age" name="age" class="form-control" value="<?php echo $age; ?>"  <?=$req;?> required>
                                          </div>
                                        <label class="col-md-2 col-form-label" for="martial_status"> Martial Status <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" onkeypress="return isNumber(event)" minlength="10" maxlength="10" id="office_contact_no" name="office_contact_no" class="form-control" value="<?php  echo $office_contact_no?>" <?=$req;?> required>
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label class="col-md-2 col-form-label" for="personal_email_id"> Personal Email Id <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <input type="email" id="personal_email_id" name="personal_email_id" class="form-control" value="<?php echo $personal_email_id; ?>" <?=$req;?> required>
                                        </div>
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <label class="col-md-2 col-form-label" for="pan_no"> Pan No <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <input type="text" id="pan_no" pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}" maxlength="10" minlength="10"  name="pan_no" class="form-control" value="<?php echo $pan_no; ?>" required >
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                    ...
                                    <div class="form-group row ">
                                        <label class="col-md-2 col-form-label" for="qualification">Graduation Type <span style="color:red">*</span> </label>
                                        <div class="col-md-4">    
                                     <select name="graduation_type" id="graduation_type" class="select2 form-control"  onchange='get_qualification(this.value)' required <?=$req;?>>
                                        <?php echo $graduation_type_option; ?>
                                     </select>
                                   </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label class="col-md-2 col-form-label" for="qualification">Degree <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <!-- <input type="text" id="qualification" name="qualification" class="form-control" value="<?php echo $qualification; ?>" > -->
                                            <select name="qualification" id="qualification" class="select2 form-control" placeholder="Select Qualification" required <?=$req;?>>
                                    ...
                                    <div class="form-group row ">
                                        <label class="col-md-2 col-form-label" for="pre_country"> Country <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <select name="pre_country" id="pre_country" class="select2 form-control" onchange="get_states(this.value);" required <?=$req;?>><?php echo $pre_country_options;?></select>
                                        </div>
                                        <label class="col-md-2 col-form-label" for="perm_country"> Country <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <select name="perm_country" id="perm_country" class="select2 form-control" onchange="get_perm_states(this.value);" required <?=$req;?>><?php echo $perm_country_options;?></select>
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label class="col-md-2 col-form-label" for="pre_state"> State <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <select name="pre_state" id="pre_state" class="select2 form-control" onchange="get_cities(this.value);" required <?=$req;?>> <?php echo $pre_state_options;?></select>
                                        </div>
                                        <label class="col-md-2 col-form-label" for="perm_state"> State <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <select name="perm_state" id="perm_state" class="select2 form-control" onchange="get_perm_cities(this.value);" required <?=$req;?>> <?php echo $perm_state_options;?></select>
                                            <input type="hidden" name="edit_perm_state_id" id="edit_perm_state_id" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label class="col-md-2 col-form-label" for="pre_city"> City <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <select name="pre_city" id="pre_city" class="select2 form-control" required <?=$req;?>><?php echo $pre_city_options;?> </select>
                                        </div>
                                        <label class="col-md-2 col-form-label" for="perm_city_name"> City <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <select name="perm_city" id="perm_city" class="select2 form-control" required <?=$req;?>> <?php echo $perm_city_options;?> </select>
                                            <input type="hidden" name="edit_perm_city_id" id="edit_perm_city_id" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label class="col-md-2 col-form-label" for="pre_building_no"> Building No <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <input type="text" id="pre_building_no" name="pre_building_no" class="form-control" value="<?php echo $pre_building_no; ?>"  <?=$req;?> required>
                                        </div>
                                        <label class="col-md-2 col-form-label" for="perm_building_no"> Building No <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <input type="text" id="perm_building_no" name="perm_building_no" class="form-control" value="<?php echo $perm_building_no; ?>" <?=$req;?> required>
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label class="col-md-2 col-form-label" for="pre_street"> Street <span style="color:red">*</span> </label>
                                        <div class="col-md-4">
                                            <input type="text" id="pre_street" name="pre_street" class="form-control" value="<?php echo $pre_street; ?>" <?=$req;?> required>
                                 </div>
                                 <label class="col-md-2 col-form-label" for="perm_street"> Street <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="perm_street" name="perm_street" class="form-control" value="<?php echo $perm_street; ?>" <?=$req;?> required>
                                 </div>
                              </div>
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="pre_area"> Area <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="pre_area" name="pre_area" class="form-control" value="<?php echo $pre_area; ?>" <?=$req;?> required>
                                 </div>
                                 <label class="col-md-2 col-form-label" for="perm_area"> Area <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="perm_area" name="perm_area" class="form-control" value="<?php echo $perm_area; ?>" <?=$req;?> required>
                                 </div>
                              </div>
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="pre_pincode"> Pincode <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="pre_pincode" name="pre_pincode"  maxlength="6" onkeypress="return isNumber(event)"  minlength="6" class="form-control" value="<?php echo $pre_pincode; ?>" <?=$req;?> required>
                                 </div>
                                 <label class="col-md-2 col-form-label" for="perm_pincode"> Pincode <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="perm_pincode" maxlength="6" minlength="6" onkeypress="return isNumber(event)" name="perm_pincode" class="form-control" value="<?php echo $perm_pincode; ?>" <?=$req;?> required>
                                 </div>
                              </div>
                              <div class="form-group row ">
                              ...
                              <div class="form-group row ">
                                 ...
                                 <label class="col-md-2 col-form-label" for="work_location"> Work Location <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <select name="work_location" id="work_location" name="work_location" class="select2 form-control" required> 
                                      <?php echo $work_location_options; ?>
                                    </select>
                                 </div>
                              </div>
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="esi_no"> ESI No <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="esi_no" name="esi_no" maxlength="20" class="form-control" value="<?php echo $esi_no; ?>" required > 
                                 </div>
                                 <label class="col-md-2 col-form-label" for="pf_no"> PF No <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="pf_no" name="pf_no"  maxlength="20"  class="form-control" value="<?php echo $pf_no; ?>" required > 
                                 </div>
                              </div>
                              <div class="form-group row ">
                                <label class="col-md-2 col-form-label" for="biometric_id"> Bio Metric Id <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input  type="text" id="biometric_id" name="biometric_id" class="form-control" value="<?php echo $biometric_id; ?>" required >
                                </div>
                                 <label class="col-md-2 col-form-label" for="company_name"> Company Name <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                 <select name="company_name" id="company_name" class="select2 form-control" required><?php echo $company_name_options; ?></select>
                                 </div>
                            </div>
                            <div class="form-group row ">
                            <label class="col-md-2 col-form-label" for="claim_status"> Salary Category <span style="color:red">*</span> </label>
                                    <div class="col-md-4">
                            ...
                            <div class="form-group row ">
                                <label class="col-md-2 col-form-label" for="biometric_id"> Staff Image <span style="color:red">*</span> </label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group row ">
                                <label class="col-md-2 col-form-label" for="premises"> Premises Type <span style="color:red">*</span> </label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group row ">
                                ...
                                <label class="col-md-2 col-form-label" for="reporting_officer"> Reporting Officer <span style="color:red">*</span></label>
                                <div class="col-md-4">
                  ...
                  <div class="tab-pane" id="account_details_tab">
                    ...
                    <div class="form-group row mb-2">
                            ...
                            <label class="col-md-2 col-form-label" for="salary_type">Salary Type <span style="color:red">*</span> </label>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                           <div class="col-12">
                              ...
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="bank_contact_no"> Contact No <span style="color:red">*</span></label>
                                 <div class="col-md-4">                                                
                                    <input type="text" id="bank_contact_no" onkeypress="return isNumber(event)" maxlength="10" name="bank_contact_no" class="form-control" value=""  required>
                                 </div>
                     ...
                     <form class="was-validated qualification_form" id="qualification_form">
                        <div class="row">
                           <div class="col-12">
                              <!-- <h4 class="header-title">Delivery / Invoice Details </h4> -->
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="education_type"> Education Type <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="education_type" name="education_type" class="form-control" value="" required>
                                 </div>
                                 <label class="col-md-2 col-form-label" for="degree"> Degree <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="degree" name="degree" class="form-control" value="" required>
                                 </div>
                              </div>
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="college_name"> College Name <span style="color:red">*</span> </label>
                                 <div class="col-md-4">                                                
                                    <input type="text" id="college_name" name="college_name" class="form-control" value=""  required>
                                 </div>
                                 <label class="col-md-2 col-form-label" for="year_passing"> Year Of Passing <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="month" id="year_passing" name="year_passing" class="form-control" value="" required>
                                 </div>
                              </div>
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="percentage"> Percentage <span style="color:red">*</span> </label>
                                 <div class="col-md-4">                                                
                                 ...
                                 <label class="col-md-2 col-form-label" for="university"> University <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="university" name="university" class="form-control" value="" required>
                                 </div>
                              </div>
                              <div class="form-group row ">
                                <label class="col-md-2 col-form-label" for="biometric_id"> Document Upload <span style="color:red">*</span> </label>
                                <div class="col-md-4">
                     ...
                     <form class="was-validated experience_form" id="experience_form">
                        <div class="row">
                           <div class="col-12">
                              <!-- <h4 class="header-title">Delivery / Invoice Details </h4> -->
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="staff_company_name"> Company <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="staff_company_name" name="staff_company_name" class="form-control" value="" required>
                                 </div>
                                 <label class="col-md-2 col-form-label" for="designation_name"> Designation <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="text" id="designation_name" name="designation_name" class="form-control" value="" required>
                                 </div>
                              </div>
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="salary_amt"> Salary <span style="color:red">*</span> </label>
                                 <div class="col-md-4">                                                
                                 ...
                                 <label class="col-md-2 col-form-label" for="join_month"> Joining Month <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="month" id="join_month" name="join_month" class="form-control" value="" required>
                                 </div>
                              </div>
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="relieve_month"> Relieving Month <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                                    <input type="month" id="relieve_month" name="relieve_month" class="form-control" value="" required>
                                 </div>
                                 <label class="col-md-2 col-form-label" for="exp"> Experience <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                        ...
                        <div class="row">
                           <div class="col-12">
                             <div class="form-group row ">
                              ...
                              <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="salary" style="color: red"> Gross <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                              ...
                              <div class="form-group row ">
                               ...
                               <div class="form-group row ">
                                 <label class="col-md-2 col-form-label" for="net_salary" style="color: red"> Net Salary <span style="color:red">*</span> </label>
                                 <div class="col-md-4">
                  ...
                  <ul class="list-inline mb-0 pager wizard">
                     ...
                     <li class="finish list-inline-item float-right mr-0">
                        <a href="http://zigma.in/blue_planet/index.php?file=staff/list" class="btn btn-asgreen btn-rounded waves-effect waves-light float-right createupdate_btn_finish">Finish</a>
                     </li>
                  </ul>
               </div>
               <!-- tab-content -->
