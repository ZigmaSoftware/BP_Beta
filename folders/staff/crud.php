...
case 'relievecreateupdate':
    ...
    case 'datatable':
        ...
        $columns        = [
            ...
            "(SELECT company_name FROM company_name_creation AS company_name WHERE company_name.unique_id = ".$table_staff_official.".company_name) AS company_name",
            "(SELECT work_location FROM work_location_creation AS work_location WHERE work_location.unique_id =".$table_staff_official.".work_location) AS work_location",
        ...
        //     $where .= " OR staff_namefe  LIKE '".mysql_like($_POST['search']['value'])."' ";
	...
	//  if(($sess_user_type == '5ff71f5fb5ca556748')){
        ...
        // }
        // else {
        //     // $staff_id  = "and unique_id = '$_SESSION['staff_id']'";
        //     if($_POST['status'] == 0){
        //         $where = " is_delete = '0' and unique_id='".$_SESSION['staff_id']."'" ;
        //     }else if($_POST['status'] == 1){
        //         $where = " is_delete = '0' and relieve_date = '' and unique_id='".$_SESSION['staff_id']."'";
        //     }else{
        //         $where = " is_delete = '0' and relieve_date != ''and unique_id='".$_SESSION['staff_id']."'";
        //     }
        // }
...
// ✅ Conditionally filter by session work_location
    ...
    $where .= " AND work_location = '$work_location'";
        ...
        if ($result->status) {
            ...
            foreach ($res_array as $key => $value) {
                ...
                //  $value['work_location'] = work_location($value['work_location'])[0]['work_location'];
