...
<style>
    /* Keep page width fixed when modals open */
    body.modal-open {
      overflow-y: scroll !important;     /* keep scrollbar always visible */
      padding-right: 0 !important;       /* cancel Bootstrap's padding compensation */
    }
    
    body.modal-open #page-content,   /* wrap your main content in #page-content */
    body.modal-open .main-wrapper {  /* or whatever wrapper you use */
      pointer-events: none;
      user-select: none;
      filter: blur(1px);             /* optional visual effect */
    }
            ...
            <div class="card-body">
                ...
                <div class="modal fade" id="statusModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">PR Item-wise Approval Status</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body">
                                <table class="table table-bordered table-sm" id="itemStatusTable">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Item Code</th>
