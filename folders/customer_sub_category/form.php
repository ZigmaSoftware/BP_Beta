...
if(isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $customer_sub_category  = $result_values[0]["customer_sub_category"];
                    ...
                    <div class="col-12">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="form-group row ">
                                <label class="col-md-2 col-form-label textright" for="customer_sub_category"> Customer Sub Category </label>
                                <div class="col-md-3">
                                    <input type="text" id="customer_sub_category" name="customer_sub_category" class="form-control" value="<?php echo $customer_sub_category; ?>" required>
                                </div>
                            </div>
                            <div class="form-group row ">
