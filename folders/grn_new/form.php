...
if(isset($_GET['unique_id'])){
    ...
    $supplier_name_options     = po_supplier($supplier_name);
}
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-12 col-12">
            <div class ="form-group row">
                ...
                <div class="col-md-7">
                    <select name="project_id" id="project_id" class="form-control select2" onchange="get_supplier_names(this.value);" <?= $is_update_mode ? 'disabled' : '' ?> required>
                        <?= $project_options ?>
                    </select>
                </div>
            </div>
