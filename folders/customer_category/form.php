...
if(isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $customer_category  = $result_values[0]["customer_category"];
                ...
                <div class="row">                                    
                    <div class="col-12">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="customer_category" name="customer_category" class="form-control" value="<?php echo $customer_category; ?>" required>
                                </div>
                                  </div>
                                 <div class="form-group row ">
