...
if(isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
       ...
       $get_uni_id = $_GET['unique_id']; // Direct use (no decryption)
        ...
        $category_name          = $result_values["category_name"];
...
<h4 class="page-title">Main Category Creation <?=$form_type;?></h4>
<div>
<ol class="breadcrumb m-0">
<li class="breadcrumb-item"><a href="javascript: void(0);">Settings</a></li>
<li class="breadcrumb-item active">Main Category Creation</li>
</ol>
</div>
</div>
</div>
