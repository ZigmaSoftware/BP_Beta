...
if(isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        $hr_approval  = $loan_values["hr_approval"];
        $hr_reason    = $loan_values["hr_reason"];
...
$approve_options = [
    [
        "id"    => 1,
        "text"  => "Accounts Approval Required"
    ],
    [
        "id"    => 2,
        "text"  => "Rejected"
...
$approve_options    = select_option($approve_options,"Select",$hr_approval);
                    ...
                    <div class="row">                                    
                        <div class="col-12">
                           <div class="form-group row ">
                            ...
                            <div class="form-group row">
                                <label for="hr_reason" class="col-md-2 col-form-label"> Reason </label>
                                <div class="col-md-4">
                                    <textarea name="hr_reason" id="hr_reason" rows="4" class="form-control " required><?=$hr_reason;?></textarea>
                                </div>
                            </div>
                            <div class="form-group row ">
                                <div class="col-md-12">
