        ...
        <form class="was-validated" id="purchase_order_form">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    ...
                    <select name="company_id" id="company_id"  class="form-control select2" disabled  onchange="get_project_name(this.value);" required>
                ...
                <div class="col-md-4">
                    ...
                    <select name="project_id" id="project_id" class="form-control select2"  disabled required>
                        <?= $project_options ?>
                    </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-md-4">
                        <input type="hidden" name="po_for" value="<?= $po_for ?>">
                            <select name="po_for" id="po_for" class="form-control select2" disabled required>
                                <?= $po_type_options; ?>
                            </select>
                </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-4">
              <input type="date" name="entry_date" id="entry_date" class="form-control" readonly value="<?= $entry_date ?>" required>
            </div>
          </div>
          ...
          <label class="col-md-2 col-form-label">PAN No</label>
          <div class="col-md-4">
        ...
        <div class="form-group row">
          <label class="col-md-2 col-form-label">Quotation No</label>
          <div class="col-md-4">
            <input type="text" name="quotation_no" id="quotation_no" class="form-control" value="<?= $quotation_no ?>" readonly placeholder="Enter Quotation Number">
          </div>
        
          <label class="col-md-2 col-form-label">Quotation Date</label>
          <div class="col-md-4">
            <input type="date" name="quotation_date" id="quotation_date" value="<?= $quotation_date ?>" readonly class="form-control">
          </div>
        </div>
        ...
        <!--  <div class="col-md-4">-->
        <!--    <input type="text" name="revision_no" id="revision_no" class="form-control" value="<?= $revision_no ?>" readonly placeholder="Enter Revision Number">-->
        <!--  </div>-->
        
        <!--  <label class="col-md-2 col-form-label">Revision Date</label>-->
        <!--  <div class="col-md-4">-->
        <!--    <input type="date" name="revision_date" id="revision_date" value="<?= $revision_date ?>"  readonly class="form-control">-->
        <!--  </div>-->
        <!--</div>-->
                        ...
                        <table id="purchase_order_sub_datatable" class="table dt-responsive nowrap w-100">
                            <thead>
                                ...
                                <tr id="po_details_form">
                                    ...
                                    <th>
                                        <input type="number" id="appr_quantity" name="appr_quantity" class="form-control" placeholder="Appr Qty" required <?= $disabled; ?> >
                                    </th>
                                    <th>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <input type="text" id="total_appr_quantity" name="total_appr_quantity" class="form-control" readonly value="0">
                                    </th>
                                    <th>
