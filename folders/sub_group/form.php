...
if(isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $sub_group_name     = $result_values[0]["sub_group_name"];
                    ...
                    <div class="col-12">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="form-group row ">
                                <label class="col-md-2 col-form-label textright" for="group_code">Group Code</label>
                                <div class="col-md-3">
                                    <input type="text" id="group_code" name="group_code" class="form-control" maxlength="3" value="<?php echo $part[0]; ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row ">
                                <label class="col-md-2 col-form-label textright" for="sub_group_name">Sub Group Name</label>
                                <div class="col-md-3">
                                    <input type="text" id="sub_group_name" name="sub_group_name" class="form-control" value="<?php echo $sub_group_name; ?>" required>
                                </div></div>
                                <div class="form-group row ">
                                <label class="col-md-2 col-form-label textright" for="code">Sub Group Code</label>
                                <div class="col-md-3">
                                    <input type="text" id="code" name="code" class="form-control" maxlength="3" oninput="allowAlphaNumeric(this)"  title="Please enter exactly 3 letters" value="<?php echo $part[1]; ?>" required>
                                </div>
