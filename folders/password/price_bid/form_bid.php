...
// $is_converted Variable came from technical_bid_submission/form.php file
if (!isset($is_converted)) {
    $is_converted = 1;
}
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h2 class="text-primary text-center">Waiting For Techical Bid Submission</h2>
...
if(isset($_GET["unique_id"])) {
    ...
    if (!empty($_GET["unique_id"])) {
        ...
        if ($select_result->status) {
            ...
            $price_bid_id       = $select_result['unique_id'];
        ...
        <div class="card">
            <div class="card-body">
                <form class="was-validated price_bid_form" name="price_bid_form" id="price_bid_form">
                    ...
                    <input type="hidden" name="price_bid_tab_show" id="price_bid_tab_show" value="1">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row ">
                                ...
                                <label class="col-md-2 col-form-label d-none <?php echo $font_weight_light; ?>" for="bid_date"> Bid Creation Date</label>
                                <label class="col-md-4 text-green d-none mt-1" for="bid_create_date"> <?php echo disdate($bid_date); ?> </label>
                            <!-- </div>
                            <div class="form-group row "> -->
                            ...
                            <div class="form-group row ">
                                <div class="col-md-12">
                                    ...
                                    <?php echo btn_createupdate('price_bid',$unique_id,$btn_text);?>
