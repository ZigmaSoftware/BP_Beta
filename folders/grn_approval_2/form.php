...
$checked_by_name = fetch_user_name($checked_by);
$formatted_checked_by = ucwords(strtolower($checked_by_name));
$checked_by = $formatted_checked_by;
...
<div class="row">
    ...
    <div class="form-group row" <?= $is_update_mode ? '' : 'style="display:none;"' ?>>
        <label class="col-md-5 col-form-label labelright" for="grn_number">GRN Number</label>
        <div class="col-md-7">
                ...
                <div class="col-md-7">
                    ...
                    <div class="col-12">                            
                       <div class="row">
                            <div class="col-12">
                            <!-- Table Begiins -->
                                <table id="grn_sublist_datatable" class="table table-striped table-bordered dt-responsive nowrap w-100">
