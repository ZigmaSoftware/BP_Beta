               ...
               <div class="row">
                  <div class="col-12">
                     ...
                     <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="call_id"> PR No </label>
                        <div class="col-md-4">
                     ...
                     <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="call_type"> Division Name </label>
                        <div class="col-md-4">
                        ...
                        <label class="col-md-2 col-form-label" for="call_id"> Purchase Request Date</label>
                        <div class="col-md-4">
                                <input type="date" name="follow_up_call_from" id="follow_up_call_from" class="form-control" max = "<?php echo $today; ?>" value="<?php echo $today; ?>" required>
                            </div>
                     ...
                     <div class="form-group row ">
                        ...
                        <label class="col-md-2 col-form-label" for="customer_id"> Staff Name </label>
                        <div class="col-md-4">
                      ...
                      <div class="row">
                                ...
                                <table id="order_product_datatable" class="table dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Unit</th>
                                            <th>Rate History</th>
                                            <th>Material Request Details</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <div class="form-group row ">
                        <label class="col-md-2 col-form-label" for="call_type"> Approve Status </label>
                        <div class="col-md-4">
                           <select name="call_type" id="call_type" class="select2 form-control" required>
                        ...
                        <label class="col-md-2 col-form-label" for="call_id"> 
                        <div class="col-md-4">
                       ...
                       <div class="form-group row ">
                        <label class="col-md-2 col-form-label" for="cur_status"> Request Reason </label>
                        <div class="col-md-4">
                           <textarea name="cur_status" id="cur_status" rows="5" class="form-control" required><?php  ?></textarea>
                        </div>
                      </div>
                       <div class="form-group row ">
                        <label class="col-md-2 col-form-label" for="cur_status"> Ho Reason </label>
                        <div class="col-md-4">
                           <textarea name="cur_status" id="cur_status" rows="5" class="form-control" required><?php  ?></textarea>
                        </div>
                      </div>
                       <div class="form-group row ">
                        <label class="col-md-2 col-form-label" for="cur_status"> Management Instruction </label>
                        <div class="col-md-4">
                           <textarea name="cur_status" id="cur_status" rows="5" class="form-control" required><?php  ?></textarea>
                        </div>
                      </div>
