...
switch ($action) {
    case 'createupdate':
        ...
        $where_app          = " is_delete = '0'  AND relieve_date='0000-00-00' AND DATE_FORMAT(date_of_join, '%Y-%m') <= '".$_POST['letter_date']."'";        
    ...
    case 'datatable_main':
        ...
        $where = " is_delete = '0' and dir_approval='4'";
        ...
        if ($result->status) {
            ...
            foreach ($res_array as $key => $value) 
            {
                ...
                $btn_view                   = btn_print($folder_name,$value['unique_id'],'salary_payable');
                ...
                if($value['dir_approval']=='4')
                {
                    $btn_approve    = "Director Approved";
                }
                elseif($value['salary_pay']=='5')
                {
                    $btn_approve    = "Accounts Approval Required";
                }
                else
                {
                    $btn_approve    = "Cancel";
                }
                $value['dir_approval']      = $btn_approve;
