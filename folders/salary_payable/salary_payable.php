                                        ...
                                        if (!empty($_GET["unique_id"])) {
                                            ...
                                            if ($result->status) {
                                                ...
                                                foreach ($res_array as $key => $value) {
                                                    ...
                                                    $table_data .="<td class='' style='color:#1abc9c;font-weight:bold;font-size:14px;' onclick=new_external_window('folders/salary_payable/staff_wise_salary_details.php?department=".$department."&unique_id=".$unique_id."');>".($value['salary_type'])."</td>";
