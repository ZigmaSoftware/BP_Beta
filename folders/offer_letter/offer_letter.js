$(document).ready(function () {
	...
	// var esi_pf_opt = $("#pf_esi").val();
	// alert(esi_pf_opt);
	// if(esi_pf_opt == '1'){alert(esi_pf_opt);
	// 	document.getElementById('esi_opt').style.display = "block";
	// }
	get_esi_pf(esi_pf_opt);
});
...
function offer_letter_cu(unique_id = "") {
...
function offer_letter_delete(unique_id = "") {
