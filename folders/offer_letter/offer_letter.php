...
//         $('.hole-page1').css('visibility', 'hidden');

//         // Use the window load event to ensure all resources are fully loaded
//         $(window).on('load', function() {
//             // Show the content after everything is loaded
//             $('.hole-page1').css('visibility', 'visible');
...
$pf_default_value_1             = 26000;
$pf_default_value_2             = 1800;
$pf_default_value_3             = 26001;
...
//pf
// mythili
if ($pf_esi == 1 && (($basic <= $pf_default_value) || ($basic <= $pf_default_value_1) || ($basic <= $pf_default_value_2) || ($basic >= $pf_default_value_3))) {
    $pf = round((($basic * 12) / 100), ($basic * 0));
} else if ($pf_esi == 2) {
    $pf = 0;
} else if ($pf_esi == 3) {
    $pf = 0;
            ...
            <div class="">
                ...
                <?php } else if(($company_name == "")||($company_name == 'Xeon')) { ?>
                    <div class="page-header mt-2" style="margin-bottom: 0px;">
                        <img src="assets/images/blue_planet_logo.png" id="header_img" class="w-100 m-6 p-0" alt="Header Image">
                    </div>
                <?php } ?>
                ...
                <div class="row mt-3" style="margin-bottom: 17px;">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="">
                            <h4 class="float-right2 mt-n1"><span class="head-bold">Date : <?= $letter_day ?><sup><?= $letter_position; ?></sup> <?= $letter_month_year; ?> </span></h4>
                        </div>
                    </div><!-- end col -->
                </div>
                <p class="bold-text mt-3" style="margin-bottom: 46px; text-align: center"><u class="p-indent" style="color: #000;">LETTER OF OFFER</u></p>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mt-3">
                            ...
                            <p class="p-indent">This has reference to your application and subsequent interview with us.We are pleased to inform you that you have been selected for the position of <strong class="p-without-indent"> “<?= $designation; ?>” </strong>with our company. </p>
                            <p class="p-indent">You will be paid a Gross Salary of INR <?=$ctc;?>/- per annum (excluding employer’s contribution to PF, Gratuity, Medical Insurance, and other benefits as per company policy. (As per the Annexure Attached). The detailed terms and conditions of employment will be issued to you on joining. You are requested to join on <?= $join_date ?>. </p>
                            <p class="p-indent">This LOI is subject to submission of Resignation & Relieving Letter from your previous Employer.</p>
                            <p class="p-indent">Kindly sign below, as an acceptance to this Letter of Offer.</p>
                            <p class="p-indent">We wish you a successful career with Xeon Waste Managers Pvt. Ltd.</p>
                            <p class="p-indent">Thanking You.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12  mt-1 mb-1" style="margin-bottom: 10px !important;">
                        ...
                        <h4 class="text-secondry bold-text">For Xeon Waste Managers Pvt. Ltd.</h4>
                    </div>
                    <div class="col-12">
                        <h4 class="text-secondry bold-text">Authorized Signatory</h4>
                    </div>
                    <div class="col-12">
                        <h5 class="text-secondry" style="margin: 26px 0px 20px!important;"> <u class="head-bold">Received and Accepted</u> : </h5>
                    </div>
                </div>
                ...
                <!-- <table class="offer_table">
                    <tr>
                        <th colspan="2" style="text-align: center;">SALARY ANNEXURE</th>

                    </tr>
                    <tr>
                        <td class="bold" style="width: 50%;">Name</td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="bold" style="border-bottom: 0px;">DOJ</td>
                ...
                <table class="offer_table">
                    <tr>
                        <th></th>
                        <th style="width: 42.4%;">PACKAGE</th>
                        <th>ANNUAL </th>
                        <th> MONTHLY </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td class="hed">Gross Salary(A)</td>
                        <td class="bold">18,000</td>
                        <td class="bold right">1,560</td>
                    ...
                    <tr>
                        <td></td>
                        <td class="hed"> Other Benefits (C)</td>
                        <td class="bold">18,000</td>
                        <td class="bold right">1,560</td>
                    ...
                    <tr>
                        <td>H</td>
                        <td>Gratuity * Pay as per Gratuity Act</td>
                        <td>45072</td>
                        <td class="right">800</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td class="hed">Retirement Benefits (D) </td>
                        <td class="bold">1, 5</td>
                        <td class="bold right">800</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td class="hed"> CTC (A+B+C+D)</td>
        ...
        <div class="card-bg">
            <div class="">
                ...
                <?php } else if ($company_id == "") { ?>
                    <div class="page-header">
                        <img src="img/logo.png" id="header_img1" class="w-100 m-0 p-0 d-print-none backgrounds" alt="Header Image">
                    </div>
                <?php } ?>
                <img src="img/cover.png" class="w-100 background_stamp d-print-none backgrounds" alt="background-stamp">
    ...
    <div class="col-12">
        <div class="card-bg">
            <div class="">
                ...
                <?php } else if ($company_id == "") { ?>
                    <div class="page-header" style="margin-bottom: 20px;">
                        <img src="img//logo.png" id="header_img2" class="w-100 m-0 p-0 d-print-none backgrounds" alt="Header Image">
                    </div>
                <?php } ?>
                <img src="img/cover.png" class="w-100 background_stamp d-print-none backgrounds" alt="background-stamp">
                <div class="page-header-space"></div>
...
<!-- <div class="row hole-page1">
    <div class="col-md-12">
        ...
        <?php } else if ($company_id == "") { ?>
            <div class="page-header" style="margin-bottom: 20px;">
                <img src="img/logo.png" id="header_img3" class="w-100 m-0 p-0 d-print-none backgrounds" alt="Header Image">
            </div>
        <?php } ?>
        <img src="img/cover.png" class="w-100 background_stamp d-print-none backgrounds" alt="background-stamp">
        <div class="page-header-space"></div>
    ...
    <div class="col-12">
        <div class="card-bg">
            <div class="">
                ...
                <?php } else if ($company_id == "") { ?>
                    <div class="page-header" style="margin-bottom: 20px;">
                        <img src="img/logo.png" id="header_img4" class="w-100 m-0 p-0 d-print-none backgrounds" alt="Header Image">
                    </div>
                <?php } ?>
                <img src="img/cover.png" class="w-100 background_stamp d-print-none backgrounds" alt="background-stamp">
                <div class="page-header-space"></div>
    ...
    <div class="col-12">
        <div class="card-bg">
            <div class="">
                ...
                <?php } else if ($company_id == "") { ?>
                    <div class="page-header" style="margin-bottom: 20px;">
                        <img src="img/logo.png" id="header_img5" class="w-100 m-0 p-0 d-print-none backgrounds" alt="Header Image">
                    </div>
                <?php } ?>
                <img src="img/cover.png" class="w-100 background_stamp d-print-none backgrounds" alt="background-stamp">
                <div class="page-header-space"></div>
