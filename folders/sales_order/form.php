...
$table_sub = "sales_order_sublist";
        ...
        if ($result_values->status) {
            ...
            $supplier_id                = $result_values["customer_id"];
            $currency                = $result_values["currency_id"];
            $exchange_rate                = $result_values["exchange_rate"];
            $contact_person_name               = $result_values["contact_person_name"];
            $customer_po_no                = $result_values["customer_po_no"];
            $company_name                = $result_values["company_id"];
            $entry_date                = $result_values["entry_date"];
            $approve_status                = $result_values["status"];
...
$currency_options         = select_option($currency_options,"Select the Curreny",$currency);
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form class="was-validated first_form" name = "first_form">
                ...
                <?php echo $approve_status_options;?>
                    ...
                    <form class="was-validated sublist-form" id="sublist-form">                            
                       <div class="row">
                            ...
                            <div class="col-12">
                            <!-- Table Begiins -->
<table id="product_sub_datatable" class="table dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Group Name</th>
                                        ...
                                        <tr id="product_details_form">
                                            ...
                                            <th>
                                                <select name="group_unique_id_sub" id="group_unique_id_sub" class="select2 form-control" onchange="get_sub_group(this.value, 1)" required>
                                                    <?php echo $group_options_sub; ?>
                                                </select>
                                            </th>
                                            <th>
                                                <select name="sub_group_unique_id_sub_list" id="sub_group_unique_id_sub_list" class="select2 form-control" onchange="get_sub_group(this.value, 2)" required>
                                                    <?php echo $sub_group_unique_id_sub_list; ?>
                                                </select>
                                            </th>
                                            <th>
                                                <select name="category_unique_id_sub" id="category_unique_id_sub" class="select2 form-control"  onchange="get_sub_group(this.value, 3)" required>
                                                    <?php echo $category_unique_id; ?>
                                                </select>
                                            </th>
                                            <th>
                                                <select name="item_unique_id_sub" id="item_unique_id_sub" class="select2 form-control" onchange="get_group_code(this.value)" required>
                                            ...
                                            <th>
                                                <button type="button" class=" btn btn-success waves-effect  waves-light product_creation_add_update_btn" onclick="product_creation_add_update()"><a href="javascript: void(0);">ADD</a></button>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
