               ...
               <div class="row">
                  <div class="col-12">
                     ...
                     <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="call_id"> Material Delivery No </label>
                        <div class="col-md-4">
                           <h4 class="text-primary"><?php echo $follow_up_call_id; ?></h4>
                          
                        </div>

                        <label class="col-md-2 col-form-label" for="call_id">Material Delivery Date</label>
                        <div class="col-md-4">
                     ...
                     <div class="form-group row ">
                        <label class="col-md-2 col-form-label" for="call_type"> From Branch Name </label>
                        <div class="col-md-4">
                           <select name="call_type" id="call_type" class="select2 form-control" required>
                           <?php echo $call_type_options; ?>                                     
                           </select>
                        </div>
                        <label class="col-md-2 col-form-label" for="customer_id"> Request No </label>
                        <div class="col-md-4">
                      ...
                      <div class="row">
                                ...
                                <table id="order_product_datatable" class="table dt-responsive nowrap w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Balance Qty</th>
                                            <th>Now Issued Qty</th>
                                            <th>Old Materila Qty</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                          ...
                          <br>
                             ...
                             <div class="form-group row ">
                        <label class="col-md-2 col-form-label" for="call_type"> Request Status </label>
                        <div class="col-md-4">
                           <select name="call_type" id="call_type" class="select2 form-control" required>
                        ...
                        <label class="col-md-2 col-form-label" for="customer_id"> Old Material Status </label>
                        <div class="col-md-4">
                           <select name="customer_id" id="customer_id" class="select2 form-control" required>
                           <option value="">Old Material Status</option>
                         ...
                         <div class="form-group row ">
                        <label class="col-md-2 col-form-label" for="cur_status"> Received By </label>
                        <div class="col-md-4">
