...
$supplier_name_options     = select_option($supplier_name_options,"Select", $client_name);
            ...
            ?>
                     ...
                     <div class="form-group row ">
                        ...
                        <div class="col-md-3 branch_div">
                           ...
                           <input type="text" id="company_code" name="company_code" class="form-control branch_div_input" value="<?php echo $company_code; ?>" readonly>
                        </div> </div>
                        
                        
                          <div class="form-group row ">
                        <label class="col-md-2 col-form-label textright" for="client_name">Client Name </label>
                        <div class="col-md-3">
                           <select name="client_name" id="client_name" class="select2 form-control branch_div_input" onchange="get_cust_details(this.value)" required>
                              <?php echo $supplier_name_options; ?>
                           </select>
                        </div>

                        <label class="col-md-2 col-form-label textright branch_div" for="capacity">Capacity</label>
                        <div class="col-md-3 branch_div">
                           <input type="text" id="capacity" name="capacity" class="form-control branch_div_input" value="<?php echo $capacity; ?>">
                        </div>                     </div>
                        <div class="form-group row ">
                        ...
                        <div class="col-md-3 branch_div">
                           <input type="text" id="project_code" name="project_code" class="form-control branch_div_input" value="<?php echo $project_code; ?>" required>
                        </div> </div>
                        
                        <div class="form-group row ">
                        <label class="col-md-2 col-form-label textright" for="project_date">Project Date </label>
                        <div class="col-md-3">
                           <input type="date" id="project_date" name="project_date" class="form-control branch_div_input" value="<?php echo $project_date; ?>" required>
                        </div>
                        ...
                        <div class="col-md-3">
                           <input type="text" id="cost_center" name="cost_center" class="form-control branch_div_input" value="<?php echo $cost_center; ?>" required readonly>
                        </div>
