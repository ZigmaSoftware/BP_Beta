...
$project_options = select_option($project_options, "All Project");
?>
<div class="row">
    <div class="col-12">
        <div class="card">
                    ...
                    <div class="row">                                    
                        <div class="col-12">
                            <div class="form-group row ">
                                ...
                                <label class="col-md-2 col-form-label" for="project"> Project</label>
                                    <div class="col-md-3">
                                        <select id="project" class="select2 form-control"  required>
                                            <?= $project_options ?>
                                        </select>
                                    </div>
