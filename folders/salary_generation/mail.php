...
// message
    ...
    if (!($staff_count->status)) {
        ...
        $body = "<div style =  'padding: 30px 0px;' class='container'>";
        $body .= "<div style = 'padding: 0px 10px 0px;' class='row header'>";
        $body .= "<div class='col-md-12'>";
        $body .= "<table width='100%' style = 'text-align: center;'>";
        $body .= "<tr>";
        $body .= "<td width='9%'><img width='100' height='100' src='http://aedservice.aedindia.com/aed_erp/img/logo-new1.png'></td>";
        $body .= "<td><h4 style = 'font-family : Bauhaus Std Medium; font-size: 22px; color: #000;margin: 0px;'>Ascent e-Digit Solutions (P) Ltd.,</h4>
                    <p style = ' color: #7a7777; font-weight: 400;font-size: 17px;margin-bottom: 0px;
    margin-top: 5px;'><i style = 'padding-right: 7px;' aria-hidden='true'></i> H.O: No. 64, Kalaimagal School Road, Erode 638001.</p>
                    <p style = ' color: #7a7777; font-weight: 400;font-size: 17px;margin-bottom: 4px;margin-top: 0px;'><i style = 'padding-right: 7px;' aria-hidden='true'></i> C.O: No. 15 Masthan Ali Garden Street, Off. S V Lingam Road, Vadapalani, Chennai - 600 026.</p></td>";
        $body .= "</tr>";
        $body .= "</table>";
        $body .= "</div>";
        $body .= "</div>";
        ...
        $body .= "<h4 style = 'margin: 0px;
    color: #000;
    font-weight: 500;
    font-family: \"Roboto\", sans-serif;font-size: 21px;'>Total Net Payable ₹".$staff_count['take_home']." <span style = 'font-size: 15px;text-transform: uppercase;'> (".  getIndianCurrency($staff_count['take_home'])." Only)</span></h4>";
        $body .= "</div>";
        $body .= "</div>";
        $body .= "</div>";
        ...
        $body.= "<a href='http://aedservice.aedindia.com/aed_erp/folders/salary_generation/pdf.php?employee_id=".$_REQUEST['employee_id']."&unique_id=".$_REQUEST['unique_id']."&entry_date=".$_REQUEST['entry_date']."'><img width='100' height='100' src='http://aedservice.aedindia.com/aed_erp/img/pdf.jpg'></a>";
