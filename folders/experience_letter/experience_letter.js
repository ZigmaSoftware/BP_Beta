...
function experience_letter_cu (unique_id = "") {
	...
	var ajax_url = sessionStorage.getItem("folder_crud_link");
		...
		$.ajax({
			...
			success : function (res) {
				...
				//alert(details['company_name']);

				$("#designation").val(details['designation']);
				$("#join_date").val(details['date_of_join']);
				$("#company_name").val(details['company_name_value']);
				$("#company_name_unique_id").val(details['company_name']);
...
function experience_letter_delete(unique_id = "") {
