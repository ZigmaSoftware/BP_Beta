                 ...
                 <div class="clearfix" class="col-md-12 ">
                    ...
                    $unique_id  = $_GET["unique_id"];
                        ...
                        $table_main_val      = [
                            $table_salary,
                                [
                                    "dir_approval,dir_reason"
                                ]
                        ];
                        $select_where_main           = ' unique_id = "'.$unique_id.'"';
                        $action_obj_main             = $pdo->select($table_main_val,$select_where_main);
                        $data_val_main               = $action_obj_main->data;
                ...
                <?php 
                                    if(isset($_GET["unique_id"])) {
                                        if (!empty($_GET["unique_id"])) {
                                            ...
                                            $unique_id  = $_GET["unique_id"];
                                            $s_no = 0;
                                            $where_list = "salary_unique_id = '".$unique_id."' and is_active = '1' and is_delete = '0' group by salary_type";
                                            ...
                                            if ($result->status) {
                                                ...
                                                foreach ($res_array as $key => $value) {
                                                    ...
                                                    $department      = explode(' ',$value['salary_type']);
                                                    if($department[1])
                                                    {
                                                    ...
                                                    $table_data .="<td class='' style='color:#1abc9c;font-weight:bold;font-size:14px;' onclick=new_external_window('folders/salary_dir_approval/staff_wise_salary_details.php?department=".$department."&unique_id=".$unique_id."');>".($value['salary_type'])."</td>";
                    ...
                    <div class="row">                                    
                        <div class="col-6">
                            <div class="form-group row ">
                                <label class="col-md-4 col-form-label" for="notes"> Approval Status </label>
                                <div class="col-md-5">
                                    <select name="app_status" id="app_status"  class="select2 form-control" required>
                                        <option value=''>Select</option>
                                        <option value='4' <?php if($data_val_main[0]['dir_approval']=='4'){ echo "selected"; } ?>>Approved</option>
                                        <option value='2' <?php if($data_val_main[0]['dir_approval']=='2'){ echo "selected"; } ?>>Cancel</option>
                                    </select>
                                </div>
                            </div>
                        </div>                              
                        <div class="col-6">
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label" for="notes"> Note </label>
                                <div class="col-md-7">
                                    <textarea name="description" id="description" class=" form-control" rows="5"><?php echo $data_val_main[0]['dir_reason']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
