...
switch ($action) {
    case 'createupdate':
        ...
        $sublist_columns  = [
            "dir_approval"          => $app_status,
            "dir_approve_by"        => $_SESSION['staff_id'],
            "dir_reason"            => $description,
            "dir_approve_date"      => date('Y-m-d H:i:s')
        ];      
    ...
    case 'datatable_main':
        ...
        $where = " is_delete = '0' and (ceo_approval='3' or dir_approval='4')";
        ...
        if ($result->status) {
            ...
            foreach ($res_array as $key => $value) 
            {
                ...
                $btn_view                   = btn_print($folder_name,$value['unique_id'],'salary_dir_approval');
