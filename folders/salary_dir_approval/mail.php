...
// message
    ...
    font-family: \"Roboto\", sans-serif;font-size: 21px;'>Total Net Payable ₹".$staff_count['take_home']." <span style = 'font-size: 15px;text-transform: uppercase;'> (".  getIndianCurrency($staff_count['take_home'])." Only)</span></h4>";
        ...
        $body.= "<a href='https://103.130.89.95/aed_erp/folders/salary_generation/pdf.php?employee_id=".$_REQUEST['employee_id']."&unique_id=".$_REQUEST['unique_id']."&entry_date=".$_REQUEST['entry_date']."'><img width='100' height='100' src='https://103.130.89.95/aed_erp/img/pdf.jpg'></a>";
