            ...
            <div class="card-body">
                ...
                <div class="row">                                    
                    <div class="col-12">
                            ...
                            <label class="col-md-2 col-form-label textright" for="material_name">Waste Name</label>
                                <div class="col-md-3">
                                    <input type="text" id="material_name" name="material_name" class="form-control" value="<?php echo $material_name; ?>" required>
                                </div></div>
                                 <div class="form-group row ">
