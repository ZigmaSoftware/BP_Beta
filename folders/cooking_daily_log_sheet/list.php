...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table id="tcs_kolkata_log_datatable" class="table dt-responsive nowrap w-100">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th>Waste Crushing/Feeding (kg)</th>
                            <th>Waste Handed Back CCP (kg)</th>
                            <th>Water (L)</th>
                            <th>Feeding pH</th>
                            <th>Digester 1 pH</th>
                            <th>Balloon 1 Position</th>
                            <th>Remarks</th>
                            <th>Action</th>
                        </tr>
                    </thead>
