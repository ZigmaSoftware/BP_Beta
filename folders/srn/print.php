...
$table_items = [
    "$sub_table gs 
        LEFT JOIN ( 
            ...
            WHERE gs2.po_unique_id = '{$srn_data['po_number']}' 
...
<div class="invoice-box">
  ...
  <div class="row header-box">
    ...
    <div class="col-5 company-info">
      ...
      <p><?= $company_name_is[0]['address'] . ' ' . $city . ', ' . $state . ', ' . $country . ' - ' . $company_name_is[0]['pin_code'] . '.' ?></p>
    </div>
    ...
    <div class="col-5 po-details text-wrap text-break">
      ...
      <p class="mb-0">
        <span style="font-size:18px; font-weight:600; color:#03407f; word-break:break-word; white-space:normal;">
         <?= $city_values[0]['srn_number'] ?> </span><br>
        <strong>Date:</strong> <?= $city_values[0]['entry_date'] ?>     </p>
    </div>
  ...
  <div class="row mb-1">
    <div class="col-6">
      <div class="backgrinfo"><h6>Supplier </h6></div>
       <p class="mb-0"><strong><?=  $supplier_data[0]['supplier_name'] ?></strong></p>
        ...
        <!--   <p class="mb-0"><b>Warehouse</b> : STR-X001 / Xeon Store </p>-->
    </div>

    <div class="col-6">
      <div class="backgrinfo"><h6>Other Details</h6></div>
      <table class="table table-sm table-borderless mb-2">
        <tr><td>Doc No:</td><td><?= $doc_no ?? "-" ?></td></tr>
        <!--<tr><td>DC No:</td><td><//?= $dc_no ?? "-" ?></td></tr>-->
        <tr><td>Invoice No :</td><td><?= $supplier_invoice_no ?? "-" ?></td></tr>
  ...
  <div class="no-overflow">
            ...
            <tbody>
                <?php foreach ($items as $i => $row): ?>
                    <tr>
                        ...
                        <td><?= $row["uom"] ?></td>
                        <td class="text-right"><?= $row["update_qty"] ?></td>
        ...
        <table class="table table-borderless totals">
            <tr><td class="text-end">Basic Value:</td><td style="width: 150px;" class="text-end"><?= number_format($base_amount, 2) ?></td></tr>
            <!--<tr><td class="text-right">PAF (+GST):</td><td class="text-right"><//?//= //number_format($total_paf, 2) ?></td></tr>-->
            <!--<tr><td class="text-right">Freight (+GST):</td><td class="text-right"><//?= //number_format($total_freight, 2) ?></td></tr>-->
            <!--<tr><td class="text-right">Other (+GST):</td><td class="text-right"><//?= //number_format($total_other, 2) ?></td></tr>-->
            <!--<tr><td class="text-right">Round Off:</td><td class="text-right"><//?= //number_format($round, 2) ?></td></tr>-->
            <tr><td class="text-end"><strong>Total Tax:</strong></td><td class="text-end"><strong><?= number_format($total_tax, 2) ?></strong></td></tr>
            <tr><td class="text-end"><strong>Total Amount:</strong></td><td class="text-end"><strong><?= number_format($grand_total, 2) ?></strong></td></tr>
        </table>
    ...
    </div> <!-- ✅ closes no-overflow here -->




  <div class="terms-note mt-2">
    <div><h6><b>Transport Details</b></h6></div>
    <div class="row">
      <div class="col-12">
        <div class="d-flex"><div style="width:150px; font-weight:500;">Transporter Name :</div><div style="width:20px;">:</div><div><?= $transporter_name ?></div></div>
        <div class="d-flex"><div style="width:150px; font-weight:500;">Vehicle No :</div><div style="width:20px;">:</div><div><?= $vehicle_no ?></div></div>
        <div class="d-flex"><div style="width:150px; font-weight:500;">EWay Bill No:</div><div style="width:20px;">:</div><div><?= $eway_bill_no ?></div></div>
        <div class="d-flex"><div style="width:150px; font-weight:500;">EWay Bill Date</div><div style="width:20px;">:</div><div><?= $eway_bill_date ?></div></div>
        <div class="d-flex"><div style="width:150px; font-weight:500;">Recieve Location: </div><div style="width:20px;">:</div><div><?= $received ?></div></div>
      </div>
    </div>
  </div>
  ...
  <div class="row mt-2">
    ...
    <div class="col-5 text-center">
      <p><strong><?= $company_name_is[0]['company_name'] ?></strong></p>
      <div class="row">
        <div class="col-6 mt-2">
          <p><strong>Prepared By</strong><br><?= $created_user_id ?></p>
        </div>
        <div class="col-6 mt-2">
          <p><strong>Authorised By</strong><br><?= $approved_by ?></p>
        </div>
...
<div class="text-center no-print mt-3">
  <button class="btn btn-primary" onclick="window.print()">Print SRN</button>
</div>
