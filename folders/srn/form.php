    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form class="was-validated funnel_form" id="srn_form" name="funnel_form">
                    ...
                    <input type="hidden" id="count_sl" name="count_sl" value="">
        ...
        <div class="col-md-4 col-sm-12 col-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <input type="text" id="eway_bill_no" name="eway_bill_no" class="form-control" value="<?= $eway_bill_no ?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-5 col-form-label labelright" for="o_invoice">Original Invoice</label>
                <div class="col-md-7">
                    <select id="o_invoice" name="o_invoice" class="form-control select2">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select id="om_manual" name="om_manual" class="form-control select2">
                        <option value="" selected disabled>Select Yes/No</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <input type="text" id="deli_challan_no" name="deli_challan_no" class="form-control" value="<?= $deli_challan_no; ?>">
                </div>
            </div>
<div class="form-group row">
        ...
        <div class="col-md-4 col-sm-12 col-12">
            <div class ="form-group row">
                ...
                <div class="col-md-7">
                    <select name="project_id" id="project_id" class="form-control select2" onchange="get_supplier_names(this.value); get_project_address(this.value); get_cost_center(this.value);" <?= $is_update_mode ? 'disabled' : '' ?> required>
                        <?= $project_options ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="purchase_order_no" id="purchase_order_no" class="form-control select2" <?= $is_update_mode ? 'disabled' : '' ?> onchange="get_po_date(this.value);" required>
                        <?= $purchase_order_no ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select id="deli_challan" name="deli_challan" class="form-control select2">
                        <option value="" selected disabled>Select Yes/No</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <input type="text" id="amd_no" name="amd_no" class="form-control" onkeypress='number_only(event);' value="<?= $amd_no; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-5 col-form-label labelright" for="tax_invoice_no">Tax Invoice No</label>
                <div class="col-md-7">
                    <input type="text" id="tax_invoice_no" name="tax_invoice_no" class="form-control" value="<?= $tax_invoice_no; ?>">
                </div>
            </div>
             <div class="form-group row">
                <label class="col-md-5 col-form-label labelright" for="received">Received At</label>
                <div class="col-md-7">
                    <input type="text" id="received" name="received" class="form-control" value="<?= $received ?>" required>
               </div>  </div>
        </div>
        ...
        <div class="col-md-4 col-sm-12 col-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select id="supplier_name" name="supplier_name" class="form-control select2" onchange="get_purchase_order_no(this.value)" <?= $is_update_mode ? 'disabled' : '' ?> required>
                ...
                <div class="col-md-7">
                    <input type="text" id="transporter_name" name="transporter_name" class="form-control" value="<?= $transporter_name; ?>">
                </div>

                <label class="col-md-5 col-form-label labelright" for="test_cert">Test Certificate</label>
                <div class="col-md-7">
                    <select id="test_cert" name="test_cert" class="form-control select2">
                        <option value="" selected disabled>Select Yes/No</option>
                ...
                <div class="col-md-7">
                    <input type="text" id="cost_center" name="cost_center" class="form-control" value="<?= $cost_center; ?>">
                </div>
                <label class="col-md-5 col-form-label labelright" for="tax_invoice_date">Tax Invoice Date</label>
                <div class="col-md-7">
                    <input type="date" id="tax_invoice_date" name="tax_invoice_date" class="form-control" value="<?= $tax_invoice_date; ?>">
                </div>
               
                <label class="col-md-5 col-form-label labelright" for="vehicle_no">Vehicle No</label>
                <div class="col-md-7">
                    <input type="text" id="vehicle_no" name="vehicle_no" class="form-control" value="<?= $vehicle_no; ?>" >
                    ...
                    <div class="col-12">                            
                        <div class="row">
                            ...
                            <div class="table-responsive">
                                <table id="srn_sublist_datatable" class="table table-striped table-bordered dt-responsive nowrap w-100" style="width:100%">
                        ...
                        <div class="form-group row" <?php if ($check_status != 2) echo 'style="display: none;"'; ?>>
                            <label for="srn_approval" class="col-md-2 col-form-label">Approval Status</label>
                            <div class="col-md-4">
                                <select name="srn_approval" id="srn_approval" class="form-control" onchange="toggleRemark()" disabled>
                        ...
                        <div class="form-group row" id="status_remark_div" <?= ($check_status != 2) ? 'style="display: none;"' : ''; ?>>
